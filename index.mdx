...
<CardGroup cols={2}>
  ...
  <Card title="Parallel Processing" icon="forward" href="/essentials/parallel-processing">
    How to enhance multiple videos at once
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Property Video Maker" icon="house" href="recipes/real-estate-recipes">
    Code recipes for using the Video Maker API
  </Card>
</CardGroup>
